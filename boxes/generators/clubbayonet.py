...
class ClubBayonet(Boxes):
    ...
    def __init__(self) -> None:
        ...
        self.argparser.add_argument(
            "--inside_diameter",  action="store", type=float, default=19,
            help="diameter of inside circle")
        self.argparser.add_argument(
            "--diameter_easing",  action="store", type=float, default=0,
            help="amount to subtract from outer section")
    ...
    def lowerLayer(self, asPart=False, move=None):
        ...
        self.hole(0, 0, d=self.inside_diameter)
    ...
    def render(self):
        ...
        self.diameter += self.diameter_easing
